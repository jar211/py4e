...
# Actual data: http://py4e-data.dr-chuck.net/comments_163208.html (Sum ends with 30)
...
# url = 'http://py4e-data.dr-chuck.net/comments_42.html' # url for sample data
url = 'http://py4e-data.dr-chuck.net/comments_163208.html' # url for actual data
...
values = list()
for span in spans:
    values.append(float(span.contents[0]))
