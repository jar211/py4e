...
# Actual data: http://py4e-data.dr-chuck.net/regex_sum_163206.txt (There are 89 values and the sum ends with 989)
# These links open in a new window. Make sure to save the file into the same folder as you will be writing your Python
# program. Note: Each student will have a distinct data file for the assignment - so only use your own data file
# for analysis.
# Data Format
...
import re
# file_name = 'regex_sum_42.txt' # test data
file_name = 'regex_sum_163206.txt' # actual data
file_handle = open(file_name, 'r')

# extract integers and store in a list
all_numbers = list()
for line in file_handle:
    # find each number on line and add to the all_numbers list
